...
public class ItemData implements ConfigurationSerializable {
    ...
    public static ItemData fromItemName(String string) {
        ItemStack stack = HCF.getPlugin().getBasePlugin().getItemDb().getItem(string);
    ...
    public String getItemName() {
        return HCF.getPlugin().getBasePlugin().getItemDb().getName(new ItemStack(material, 1, itemData));
    }

    @Override
    public String toString() {
        return material.name() + "(" + itemData + ")";
    }
