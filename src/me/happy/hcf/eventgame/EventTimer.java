...
import me.happy.hcf.faction.event.CaptureZoneEnterEvent;
import me.happy.hcf.faction.event.CaptureZoneLeaveEvent;
import me.happy.hcf.faction.type.Faction;
import me.happy.hcf.faction.type.PlayerFaction;
import me.happy.hcf.timer.GlobalTimer;
    ...
    public EventTimer(HCF plugin) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                LocalDateTime now = LocalDateTime.now(ConfigurationService.SERVER_TIME_ZONE.toZoneId());
